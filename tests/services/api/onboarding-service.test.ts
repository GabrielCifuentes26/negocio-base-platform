...
describe("bootstrapBusinessWorkspace", () => {
  ...
  it("maps the onboarding payload to the expected RPC parameters", async () => {
    ...
    const result = await bootstrapBusinessWorkspace({
      ...
      initialHours: [
        { day: "monday", label: "Lunes", isOpen: true, opensAt: "08:00", closesAt: "17:00" },
      ],
      seedServices: [
        { name: "Consulta inicial", description: "Primera visita", durationMinutes: 40, price: 250 },
      ],
      seedProducts: [],
      primaryColor: "#123456",
      accentColor: "#fef3c7",
    ...
    expect(rpcMock).toHaveBeenCalledWith("bootstrap_business_workspace", {
      ...
      initial_hours: [{ day: "monday", label: "Lunes", isOpen: true, opensAt: "08:00", closesAt: "17:00" }],
      seed_services: [{ name: "Consulta inicial", description: "Primera visita", durationMinutes: 40, price: 250 }],
      seed_products: [],
