...
declare
  ...
  range_start_date date := current_date - (effective_range - 1);
  range_end_date date := current_date;
  previous_range_end_date date := range_start_date - 1;
  previous_range_start_date date := previous_range_end_date - (effective_range - 1);
